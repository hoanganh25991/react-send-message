...
export default class SendMessage extends PureComponent {
  ...
  publishPostX = async () => {
    ...
    const success = await publishPost({ pageId, pageToken })({ text: postMsg, url, imgFile })
  ...
  render() {
    ...
    const { page: { id: pageId, access_token: pageToken } = {} } = this.props
    const { customers, isSending, msg, isPosting, postMsg, postUrl, postImgFile } = this.state
      ...
      <div style={s.rootDiv}>
        ...
        <div style={s.postContainerDiv}>
          ...
          <div style={s.imgContainerDiv}>
            ...
            />
            <div className={"postBtn"} style={s.postDivBtn} onClick={this.publishPostX}>
              {postBtnTxt}
            </div>
          </div>
        </div>
        ...
        {hasCustomer && (
          <div style={s.msgContainerDiv}>
            ...
            <div style={s.sendCmdContainerDiv}>
              ...
              <div className={"fb-message-blue"} style={s.sendDivBtn} onClick={this.broadcastMsg}>
                <i /> {sendBtnTxt}
              </div>
            </div>
          </div>
